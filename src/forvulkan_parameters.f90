module forvulkan_parameters
  ...
  integer(c_int32_t), parameter, public :: VK_ATTACHMENT_STORE_OP_STORE = 0
  integer(c_int32_t), parameter, public :: VK_ATTACHMENT_STORE_OP_DONT_CARE = 1
  ! Provided by VK_VERSION_1_3
  integer(c_int32_t), parameter, public :: VK_ATTACHMENT_STORE_OP_NONE = 1000301000
  ! Provided by VK_KHR_dynamic_rendering VK_KHR_load_store_op_none
  integer(c_int32_t), parameter, public :: VK_ATTACHMENT_STORE_OP_NONE_KHR = VK_ATTACHMENT_STORE_OP_NONE
  ! Provided by VK_QCOM_render_pass_store_ops
  integer(c_int32_t), parameter, public :: VK_ATTACHMENT_STORE_OP_NONE_QCOM = VK_ATTACHMENT_STORE_OP_NONE
  ! Provided by VK_EXT_load_store_op_none
  ...
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_SAMPLER = 0
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER = 1
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE = 2
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_STORAGE_IMAGE = 3
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER = 4
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER = 5
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER = 6
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_STORAGE_BUFFER = 7
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC = 8
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC = 9
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT = 10
  ! Provided by VK_VERSION_1_3
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK = 1000138000
  ! Provided by VK_KHR_acceleration_structure
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR = 1000150000
  ! Provided by VK_NV_ray_tracing
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_NV = 1000165000
  ! Provided by VK_QCOM_image_processing
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_SAMPLE_WEIGHT_IMAGE_QCOM = 1000440000
  ! Provided by VK_QCOM_image_processing
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_BLOCK_MATCH_IMAGE_QCOM = 1000440001
  ! Provided by VK_EXT_mutable_descriptor_type
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_MUTABLE_EXT = 1000351000
  ! Provided by VK_EXT_inline_uniform_block
  integer(c_int32_t), parameter, public :: VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT = VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK
  ! Provided by VK_VALVE_mutable_descriptor_type
