module forvulkan_parameters
  ...
  integer(c_int), parameter, public :: VK_COLOR_SPACE_SRGB_NONLINEAR_KHR = 0
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_DISPLAY_P3_NONLINEAR_EXT = 1000104001
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_EXTENDED_SRGB_LINEAR_EXT = 1000104002
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_DISPLAY_P3_LINEAR_EXT = 1000104003
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_DCI_P3_NONLINEAR_EXT = 1000104004
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_BT709_LINEAR_EXT = 1000104005
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_BT709_NONLINEAR_EXT = 1000104006
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_BT2020_LINEAR_EXT = 1000104007
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_HDR10_ST2084_EXT = 1000104008
  ! Provided by VK_EXT_swapchain_colorspace
  ! VK_COLOR_SPACE_DOLBYVISION_EXT is deprecated but no reason was given in the API XML
  integer(c_int), parameter, public :: VK_COLOR_SPACE_DOLBYVISION_EXT = 1000104009
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_HDR10_HLG_EXT = 1000104010
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_ADOBERGB_LINEAR_EXT = 1000104011
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_ADOBERGB_NONLINEAR_EXT = 1000104012
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_PASS_THROUGH_EXT = 1000104013
  ! Provided by VK_EXT_swapchain_colorspace
  integer(c_int), parameter, public :: VK_COLOR_SPACE_EXTENDED_SRGB_NONLINEAR_EXT = 1000104014
  ! Provided by VK_AMD_display_native_hdr
  integer(c_int), parameter, public :: VK_COLOR_SPACE_DISPLAY_NATIVE_AMD = 1000213000
  ! VK_COLORSPACE_SRGB_NONLINEAR_KHR is a deprecated alias
  integer(c_int), parameter, public :: VK_COLORSPACE_SRGB_NONLINEAR_KHR = VK_COLOR_SPACE_SRGB_NONLINEAR_KHR
  ! Provided by VK_EXT_swapchain_colorspace
  ! VK_COLOR_SPACE_DCI_P3_LINEAR_EXT is a deprecated alias
  integer(c_int), parameter, public :: VK_COLOR_SPACE_DCI_P3_LINEAR_EXT = VK_COLOR_SPACE_DISPLAY_P3_LINEAR_EXT


  !? VkPresentModeKHR.


  integer(c_int), parameter, public :: VK_PRESENT_MODE_IMMEDIATE_KHR = 0
  integer(c_int), parameter, public :: VK_PRESENT_MODE_MAILBOX_KHR = 1
  integer(c_int), parameter, public :: VK_PRESENT_MODE_FIFO_KHR = 2
  integer(c_int), parameter, public :: VK_PRESENT_MODE_FIFO_RELAXED_KHR = 3
  ! Provided by VK_KHR_shared_presentable_image
  integer(c_int), parameter, public :: VK_PRESENT_MODE_SHARED_DEMAND_REFRESH_KHR = 1000111000
  ! Provided by VK_KHR_shared_presentable_image
  integer(c_int), parameter, public :: VK_PRESENT_MODE_SHARED_CONTINUOUS_REFRESH_KHR = 1000111001
  ...
  integer(c_int), parameter, public :: VK_IMAGE_VIEW_TYPE_1D = 0
  integer(c_int), parameter, public :: VK_IMAGE_VIEW_TYPE_2D = 1
  integer(c_int), parameter, public :: VK_IMAGE_VIEW_TYPE_3D = 2
  integer(c_int), parameter, public :: VK_IMAGE_VIEW_TYPE_CUBE = 3
  integer(c_int), parameter, public :: VK_IMAGE_VIEW_TYPE_1D_ARRAY = 4
  integer(c_int), parameter, public :: VK_IMAGE_VIEW_TYPE_2D_ARRAY = 5
