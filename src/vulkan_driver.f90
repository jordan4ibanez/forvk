...
!* INITIALIZATION. ====================================================================
  ...
  subroutine init_vulkan()
    ...
    call draw_frame(logical_device, in_flight_fence, image_available_semaphore, swapchain, command_buffer, render_pass, swapchain_framebuffers, swapchain_extent, graphics_pipeline, render_finished_semaphore, graphics_queue)
