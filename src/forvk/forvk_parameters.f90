module forvk_parameters
  ...
  character(len = 1, kind = c_char), parameter :: VK_KHR_SURFACE_EXTENSION_NAME =     "VK_KHR_surface"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SWAPCHAIN_EXTENSION_NAME =   "VK_KHR_swapchain"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DISPLAY_EXTENSION_NAME =     "VK_KHR_display"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DISPLAY_SWAPCHAIN_EXTENSION_NAME = "VK_KHR_display_swapchain"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_EXTENSION_NAME = "VK_KHR_sampler_mirror_clamp_to_edge"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_QUEUE_EXTENSION_NAME = "VK_KHR_video_queue"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_DECODE_QUEUE_EXTENSION_NAME = "VK_KHR_video_decode_queue"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_ENCODE_H264_EXTENSION_NAME = "VK_KHR_video_encode_h264"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_ENCODE_H265_EXTENSION_NAME = "VK_KHR_video_encode_h265"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_DECODE_H264_EXTENSION_NAME = "VK_KHR_video_decode_h264"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME = "VK_KHR_dynamic_rendering"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MULTIVIEW_EXTENSION_NAME =   "VK_KHR_multiview"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME = "VK_KHR_get_physical_device_properties2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DEVICE_GROUP_EXTENSION_NAME = "VK_KHR_device_group"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_DRAW_PARAMETERS_EXTENSION_NAME = "VK_KHR_shader_draw_parameters"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_1_EXTENSION_NAME = "VK_KHR_maintenance1"//achar(0)
! VK_KHR_MAINTENANCE1_EXTENSION_NAME is a deprecated alias
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE1_EXTENSION_NAME = VK_KHR_MAINTENANCE_1_EXTENSION_NAME
  character(len = 1, kind = c_char), parameter :: VK_KHR_DEVICE_GROUP_CREATION_EXTENSION_NAME = "VK_KHR_device_group_creation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME = "VK_KHR_external_memory_capabilities"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME = "VK_KHR_external_memory"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_MEMORY_FD_EXTENSION_NAME = "VK_KHR_external_memory_fd"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME = "VK_KHR_external_semaphore_capabilities"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_SEMAPHORE_EXTENSION_NAME = "VK_KHR_external_semaphore"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME = "VK_KHR_external_semaphore_fd"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME = "VK_KHR_push_descriptor"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME = "VK_KHR_shader_float16_int8"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_16BIT_STORAGE_EXTENSION_NAME = "VK_KHR_16bit_storage"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_INCREMENTAL_PRESENT_EXTENSION_NAME = "VK_KHR_incremental_present"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DESCRIPTOR_UPDATE_TEMPLATE_EXTENSION_NAME = "VK_KHR_descriptor_update_template"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_IMAGELESS_FRAMEBUFFER_EXTENSION_NAME = "VK_KHR_imageless_framebuffer"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME = "VK_KHR_create_renderpass2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHARED_PRESENTABLE_IMAGE_EXTENSION_NAME = "VK_KHR_shared_presentable_image"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_FENCE_CAPABILITIES_EXTENSION_NAME = "VK_KHR_external_fence_capabilities"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_FENCE_EXTENSION_NAME = "VK_KHR_external_fence"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_EXTERNAL_FENCE_FD_EXTENSION_NAME = "VK_KHR_external_fence_fd"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PERFORMANCE_QUERY_EXTENSION_NAME = "VK_KHR_performance_query"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_2_EXTENSION_NAME = "VK_KHR_maintenance2"//achar(0)
! VK_KHR_MAINTENANCE2_EXTENSION_NAME is a deprecated alias
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE2_EXTENSION_NAME = VK_KHR_MAINTENANCE_2_EXTENSION_NAME
  character(len = 1, kind = c_char), parameter :: VK_KHR_GET_SURFACE_CAPABILITIES_2_EXTENSION_NAME = "VK_KHR_get_surface_capabilities2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VARIABLE_POINTERS_EXTENSION_NAME = "VK_KHR_variable_pointers"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_GET_DISPLAY_PROPERTIES_2_EXTENSION_NAME = "VK_KHR_get_display_properties2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME = "VK_KHR_dedicated_allocation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_STORAGE_BUFFER_STORAGE_CLASS_EXTENSION_NAME = "VK_KHR_storage_buffer_storage_class"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_RELAXED_BLOCK_LAYOUT_EXTENSION_NAME = "VK_KHR_relaxed_block_layout"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME = "VK_KHR_get_memory_requirements2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_IMAGE_FORMAT_LIST_EXTENSION_NAME = "VK_KHR_image_format_list"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME = "VK_KHR_sampler_ycbcr_conversion"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_BIND_MEMORY_2_EXTENSION_NAME = "VK_KHR_bind_memory2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_3_EXTENSION_NAME = "VK_KHR_maintenance3"//achar(0)
! VK_KHR_MAINTENANCE3_EXTENSION_NAME is a deprecated alias
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE3_EXTENSION_NAME = VK_KHR_MAINTENANCE_3_EXTENSION_NAME
  character(len = 1, kind = c_char), parameter :: VK_KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME = "VK_KHR_draw_indirect_count"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_EXTENSION_NAME = "VK_KHR_shader_subgroup_extended_types"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_8BIT_STORAGE_EXTENSION_NAME = "VK_KHR_8bit_storage"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_ATOMIC_INT64_EXTENSION_NAME = "VK_KHR_shader_atomic_int64"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_CLOCK_EXTENSION_NAME = "VK_KHR_shader_clock"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_DECODE_H265_EXTENSION_NAME = "VK_KHR_video_decode_h265"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_GLOBAL_PRIORITY_EXTENSION_NAME = "VK_KHR_global_priority"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DRIVER_PROPERTIES_EXTENSION_NAME = "VK_KHR_driver_properties"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME = "VK_KHR_shader_float_controls"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DEPTH_STENCIL_RESOLVE_EXTENSION_NAME = "VK_KHR_depth_stencil_resolve"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SWAPCHAIN_MUTABLE_FORMAT_EXTENSION_NAME = "VK_KHR_swapchain_mutable_format"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME = "VK_KHR_timeline_semaphore"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME = "VK_KHR_vulkan_memory_model"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_TERMINATE_INVOCATION_EXTENSION_NAME = "VK_KHR_shader_terminate_invocation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_FRAGMENT_SHADING_RATE_EXTENSION_NAME = "VK_KHR_fragment_shading_rate"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DYNAMIC_RENDERING_LOCAL_READ_EXTENSION_NAME = "VK_KHR_dynamic_rendering_local_read"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_QUAD_CONTROL_EXTENSION_NAME = "VK_KHR_shader_quad_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SPIRV_1_4_EXTENSION_NAME =   "VK_KHR_spirv_1_4"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SURFACE_PROTECTED_CAPABILITIES_EXTENSION_NAME = "VK_KHR_surface_protected_capabilities"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_EXTENSION_NAME = "VK_KHR_separate_depth_stencil_layouts"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PRESENT_WAIT_EXTENSION_NAME = "VK_KHR_present_wait"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_EXTENSION_NAME = "VK_KHR_uniform_buffer_standard_layout"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME = "VK_KHR_buffer_device_address"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_DEFERRED_HOST_OPERATIONS_EXTENSION_NAME = "VK_KHR_deferred_host_operations"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PIPELINE_EXECUTABLE_PROPERTIES_EXTENSION_NAME = "VK_KHR_pipeline_executable_properties"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAP_MEMORY_2_EXTENSION_NAME = "VK_KHR_map_memory2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME = "VK_KHR_shader_integer_dot_product"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PIPELINE_LIBRARY_EXTENSION_NAME = "VK_KHR_pipeline_library"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_NON_SEMANTIC_INFO_EXTENSION_NAME = "VK_KHR_shader_non_semantic_info"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PRESENT_ID_EXTENSION_NAME =  "VK_KHR_present_id"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_ENCODE_QUEUE_EXTENSION_NAME = "VK_KHR_video_encode_queue"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME = "VK_KHR_synchronization2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME = "VK_KHR_fragment_shader_barycentric"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_EXTENSION_NAME = "VK_KHR_shader_subgroup_uniform_control_flow"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_ZERO_INITIALIZE_WORKGROUP_MEMORY_EXTENSION_NAME = "VK_KHR_zero_initialize_workgroup_memory"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_EXTENSION_NAME = "VK_KHR_workgroup_memory_explicit_layout"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_COPY_COMMANDS_2_EXTENSION_NAME = "VK_KHR_copy_commands2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_FORMAT_FEATURE_FLAGS_2_EXTENSION_NAME = "VK_KHR_format_feature_flags2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_RAY_TRACING_MAINTENANCE_1_EXTENSION_NAME = "VK_KHR_ray_tracing_maintenance1"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME = "VK_KHR_portability_enumeration"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_4_EXTENSION_NAME = "VK_KHR_maintenance4"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_SUBGROUP_ROTATE_EXTENSION_NAME = "VK_KHR_shader_subgroup_rotate"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_MAXIMAL_RECONVERGENCE_EXTENSION_NAME = "VK_KHR_shader_maximal_reconvergence"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_5_EXTENSION_NAME = "VK_KHR_maintenance5"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_RAY_TRACING_POSITION_FETCH_EXTENSION_NAME = "VK_KHR_ray_tracing_position_fetch"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_PIPELINE_BINARY_EXTENSION_NAME = "VK_KHR_pipeline_binary"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_COOPERATIVE_MATRIX_EXTENSION_NAME = "VK_KHR_cooperative_matrix"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME = "VK_KHR_compute_shader_derivatives"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_DECODE_AV1_EXTENSION_NAME = "VK_KHR_video_decode_av1"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VIDEO_MAINTENANCE_1_EXTENSION_NAME = "VK_KHR_video_maintenance1"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME = "VK_KHR_vertex_attribute_divisor"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_LOAD_STORE_OP_NONE_EXTENSION_NAME = "VK_KHR_load_store_op_none"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_FLOAT_CONTROLS_2_EXTENSION_NAME = "VK_KHR_shader_float_controls2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_INDEX_TYPE_UINT8_EXTENSION_NAME = "VK_KHR_index_type_uint8"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_LINE_RASTERIZATION_EXTENSION_NAME = "VK_KHR_line_rasterization"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_CALIBRATED_TIMESTAMPS_EXTENSION_NAME = "VK_KHR_calibrated_timestamps"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_EXPECT_ASSUME_EXTENSION_NAME = "VK_KHR_shader_expect_assume"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_6_EXTENSION_NAME = "VK_KHR_maintenance6"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_SHADER_RELAXED_EXTENDED_INSTRUCTION_EXTENSION_NAME = "VK_KHR_shader_relaxed_extended_instruction"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_MAINTENANCE_7_EXTENSION_NAME = "VK_KHR_maintenance7"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEBUG_REPORT_EXTENSION_NAME = "VK_EXT_debug_report"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_GLSL_SHADER_EXTENSION_NAME =  "VK_NV_glsl_shader"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEPTH_RANGE_UNRESTRICTED_EXTENSION_NAME = "VK_EXT_depth_range_unrestricted"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_IMG_FILTER_CUBIC_EXTENSION_NAME = "VK_IMG_filter_cubic"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_RASTERIZATION_ORDER_EXTENSION_NAME = "VK_AMD_rasterization_order"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_TRINARY_MINMAX_EXTENSION_NAME = "VK_AMD_shader_trinary_minmax"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_EXTENSION_NAME = "VK_AMD_shader_explicit_vertex_parameter"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEBUG_MARKER_EXTENSION_NAME = "VK_EXT_debug_marker"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_GCN_SHADER_EXTENSION_NAME =  "VK_AMD_gcn_shader"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DEDICATED_ALLOCATION_EXTENSION_NAME = "VK_NV_dedicated_allocation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_TRANSFORM_FEEDBACK_EXTENSION_NAME = "VK_EXT_transform_feedback"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NVX_BINARY_IMPORT_EXTENSION_NAME = "VK_NVX_binary_import"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NVX_IMAGE_VIEW_HANDLE_EXTENSION_NAME = "VK_NVX_image_view_handle"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_DRAW_INDIRECT_COUNT_EXTENSION_NAME = "VK_AMD_draw_indirect_count"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_NEGATIVE_VIEWPORT_HEIGHT_EXTENSION_NAME = "VK_AMD_negative_viewport_height"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_GPU_SHADER_HALF_FLOAT_EXTENSION_NAME = "VK_AMD_gpu_shader_half_float"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_BALLOT_EXTENSION_NAME = "VK_AMD_shader_ballot"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_TEXTURE_GATHER_BIAS_LOD_EXTENSION_NAME = "VK_AMD_texture_gather_bias_lod"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_INFO_EXTENSION_NAME = "VK_AMD_shader_info"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_IMAGE_LOAD_STORE_LOD_EXTENSION_NAME = "VK_AMD_shader_image_load_store_lod"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_CORNER_SAMPLED_IMAGE_EXTENSION_NAME = "VK_NV_corner_sampled_image"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_IMG_FORMAT_PVRTC_EXTENSION_NAME = "VK_IMG_format_pvrtc"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME = "VK_NV_external_memory_capabilities"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_EXTERNAL_MEMORY_EXTENSION_NAME = "VK_NV_external_memory"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_VALIDATION_FLAGS_EXTENSION_NAME = "VK_EXT_validation_flags"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_SUBGROUP_BALLOT_EXTENSION_NAME = "VK_EXT_shader_subgroup_ballot"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_SUBGROUP_VOTE_EXTENSION_NAME = "VK_EXT_shader_subgroup_vote"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_TEXTURE_COMPRESSION_ASTC_HDR_EXTENSION_NAME = "VK_EXT_texture_compression_astc_hdr"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_ASTC_DECODE_MODE_EXTENSION_NAME = "VK_EXT_astc_decode_mode"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PIPELINE_ROBUSTNESS_EXTENSION_NAME = "VK_EXT_pipeline_robustness"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_CONDITIONAL_RENDERING_EXTENSION_NAME = "VK_EXT_conditional_rendering"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_CLIP_SPACE_W_SCALING_EXTENSION_NAME = "VK_NV_clip_space_w_scaling"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DIRECT_MODE_DISPLAY_EXTENSION_NAME = "VK_EXT_direct_mode_display"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DISPLAY_SURFACE_COUNTER_EXTENSION_NAME = "VK_EXT_display_surface_counter"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DISPLAY_CONTROL_EXTENSION_NAME = "VK_EXT_display_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_GOOGLE_DISPLAY_TIMING_EXTENSION_NAME = "VK_GOOGLE_display_timing"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SAMPLE_MASK_OVERRIDE_COVERAGE_EXTENSION_NAME = "VK_NV_sample_mask_override_coverage"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_GEOMETRY_SHADER_PASSTHROUGH_EXTENSION_NAME = "VK_NV_geometry_shader_passthrough"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME = "VK_NV_viewport_array2"//achar(0)
! VK_NV_VIEWPORT_ARRAY2_EXTENSION_NAME is a deprecated alias
  character(len = 1, kind = c_char), parameter :: VK_NV_VIEWPORT_ARRAY2_EXTENSION_NAME = VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME
  character(len = 1, kind = c_char), parameter :: VK_NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_EXTENSION_NAME = "VK_NVX_multiview_per_view_attributes"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_VIEWPORT_SWIZZLE_EXTENSION_NAME = "VK_NV_viewport_swizzle"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DISCARD_RECTANGLES_EXTENSION_NAME = "VK_EXT_discard_rectangles"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME = "VK_EXT_conservative_rasterization"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEPTH_CLIP_ENABLE_EXTENSION_NAME = "VK_EXT_depth_clip_enable"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SWAPCHAIN_COLOR_SPACE_EXTENSION_NAME = "VK_EXT_swapchain_colorspace"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_HDR_METADATA_EXTENSION_NAME = "VK_EXT_hdr_metadata"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_IMG_RELAXED_LINE_RASTERIZATION_EXTENSION_NAME = "VK_IMG_relaxed_line_rasterization"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_EXTERNAL_MEMORY_DMA_BUF_EXTENSION_NAME = "VK_EXT_external_memory_dma_buf"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_QUEUE_FAMILY_FOREIGN_EXTENSION_NAME = "VK_EXT_queue_family_foreign"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEBUG_UTILS_EXTENSION_NAME = "VK_EXT_debug_utils"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SAMPLER_FILTER_MINMAX_EXTENSION_NAME = "VK_EXT_sampler_filter_minmax"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_GPU_SHADER_INT16_EXTENSION_NAME = "VK_AMD_gpu_shader_int16"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_MIXED_ATTACHMENT_SAMPLES_EXTENSION_NAME = "VK_AMD_mixed_attachment_samples"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_FRAGMENT_MASK_EXTENSION_NAME = "VK_AMD_shader_fragment_mask"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_INLINE_UNIFORM_BLOCK_EXTENSION_NAME = "VK_EXT_inline_uniform_block"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_STENCIL_EXPORT_EXTENSION_NAME = "VK_EXT_shader_stencil_export"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SAMPLE_LOCATIONS_EXTENSION_NAME = "VK_EXT_sample_locations"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME = "VK_EXT_blend_operation_advanced"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_FRAGMENT_COVERAGE_TO_COLOR_EXTENSION_NAME = "VK_NV_fragment_coverage_to_color"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_FRAMEBUFFER_MIXED_SAMPLES_EXTENSION_NAME = "VK_NV_framebuffer_mixed_samples"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_FILL_RECTANGLE_EXTENSION_NAME = "VK_NV_fill_rectangle"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SHADER_SM_BUILTINS_EXTENSION_NAME = "VK_NV_shader_sm_builtins"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_POST_DEPTH_COVERAGE_EXTENSION_NAME = "VK_EXT_post_depth_coverage"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_DRM_FORMAT_MODIFIER_EXTENSION_NAME = "VK_EXT_image_drm_format_modifier"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_VALIDATION_CACHE_EXTENSION_NAME = "VK_EXT_validation_cache"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME = "VK_EXT_descriptor_indexing"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME = "VK_EXT_shader_viewport_index_layer"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SHADING_RATE_IMAGE_EXTENSION_NAME = "VK_NV_shading_rate_image"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_RAY_TRACING_EXTENSION_NAME =  "VK_NV_ray_tracing"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_REPRESENTATIVE_FRAGMENT_TEST_EXTENSION_NAME = "VK_NV_representative_fragment_test"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_FILTER_CUBIC_EXTENSION_NAME = "VK_EXT_filter_cubic"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_RENDER_PASS_SHADER_RESOLVE_EXTENSION_NAME = "VK_QCOM_render_pass_shader_resolve"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_GLOBAL_PRIORITY_EXTENSION_NAME = "VK_EXT_global_priority"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_EXTERNAL_MEMORY_HOST_EXTENSION_NAME = "VK_EXT_external_memory_host"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_BUFFER_MARKER_EXTENSION_NAME = "VK_AMD_buffer_marker"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_PIPELINE_COMPILER_CONTROL_EXTENSION_NAME = "VK_AMD_pipeline_compiler_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_CALIBRATED_TIMESTAMPS_EXTENSION_NAME = "VK_EXT_calibrated_timestamps"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_CORE_PROPERTIES_EXTENSION_NAME = "VK_AMD_shader_core_properties"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_MEMORY_OVERALLOCATION_BEHAVIOR_EXTENSION_NAME = "VK_AMD_memory_overallocation_behavior"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME = "VK_EXT_vertex_attribute_divisor"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PIPELINE_CREATION_FEEDBACK_EXTENSION_NAME = "VK_EXT_pipeline_creation_feedback"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME = "VK_NV_shader_subgroup_partitioned"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME = "VK_NV_compute_shader_derivatives"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_MESH_SHADER_EXTENSION_NAME =  "VK_NV_mesh_shader"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME = "VK_NV_fragment_shader_barycentric"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SHADER_IMAGE_FOOTPRINT_EXTENSION_NAME = "VK_NV_shader_image_footprint"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SCISSOR_EXCLUSIVE_EXTENSION_NAME = "VK_NV_scissor_exclusive"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_EXTENSION_NAME = "VK_NV_device_diagnostic_checkpoints"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_INTEL_SHADER_INTEGER_FUNCTIONS_2_EXTENSION_NAME = "VK_INTEL_shader_integer_functions2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_INTEL_PERFORMANCE_QUERY_EXTENSION_NAME = "VK_INTEL_performance_query"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PCI_BUS_INFO_EXTENSION_NAME = "VK_EXT_pci_bus_info"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_DISPLAY_NATIVE_HDR_EXTENSION_NAME = "VK_AMD_display_native_hdr"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_FRAGMENT_DENSITY_MAP_EXTENSION_NAME = "VK_EXT_fragment_density_map"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SCALAR_BLOCK_LAYOUT_EXTENSION_NAME = "VK_EXT_scalar_block_layout"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME = "VK_GOOGLE_hlsl_functionality1"//achar(0)
! VK_GOOGLE_HLSL_FUNCTIONALITY1_EXTENSION_NAME is a deprecated alias
  character(len = 1, kind = c_char), parameter :: VK_GOOGLE_HLSL_FUNCTIONALITY1_EXTENSION_NAME = VK_GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME
  character(len = 1, kind = c_char), parameter :: VK_GOOGLE_DECORATE_STRING_EXTENSION_NAME = "VK_GOOGLE_decorate_string"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SUBGROUP_SIZE_CONTROL_EXTENSION_NAME = "VK_EXT_subgroup_size_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_CORE_PROPERTIES_2_EXTENSION_NAME = "VK_AMD_shader_core_properties2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_DEVICE_COHERENT_MEMORY_EXTENSION_NAME = "VK_AMD_device_coherent_memory"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_IMAGE_ATOMIC_INT64_EXTENSION_NAME = "VK_EXT_shader_image_atomic_int64"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MEMORY_BUDGET_EXTENSION_NAME = "VK_EXT_memory_budget"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MEMORY_PRIORITY_EXTENSION_NAME = "VK_EXT_memory_priority"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DEDICATED_ALLOCATION_IMAGE_ALIASING_EXTENSION_NAME = "VK_NV_dedicated_allocation_image_aliasing"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME = "VK_EXT_buffer_device_address"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_TOOLING_INFO_EXTENSION_NAME = "VK_EXT_tooling_info"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SEPARATE_STENCIL_USAGE_EXTENSION_NAME = "VK_EXT_separate_stencil_usage"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_VALIDATION_FEATURES_EXTENSION_NAME = "VK_EXT_validation_features"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_COOPERATIVE_MATRIX_EXTENSION_NAME = "VK_NV_cooperative_matrix"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME = "VK_NV_coverage_reduction_mode"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_FRAGMENT_SHADER_INTERLOCK_EXTENSION_NAME = "VK_EXT_fragment_shader_interlock"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME = "VK_EXT_ycbcr_image_arrays"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PROVOKING_VERTEX_EXTENSION_NAME = "VK_EXT_provoking_vertex"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_HEADLESS_SURFACE_EXTENSION_NAME = "VK_EXT_headless_surface"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_LINE_RASTERIZATION_EXTENSION_NAME = "VK_EXT_line_rasterization"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_ATOMIC_FLOAT_EXTENSION_NAME = "VK_EXT_shader_atomic_float"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_HOST_QUERY_RESET_EXTENSION_NAME = "VK_EXT_host_query_reset"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_INDEX_TYPE_UINT8_EXTENSION_NAME = "VK_EXT_index_type_uint8"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME = "VK_EXT_extended_dynamic_state"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_HOST_IMAGE_COPY_EXTENSION_NAME = "VK_EXT_host_image_copy"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MAP_MEMORY_PLACED_EXTENSION_NAME = "VK_EXT_map_memory_placed"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_ATOMIC_FLOAT_2_EXTENSION_NAME = "VK_EXT_shader_atomic_float2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SURFACE_MAINTENANCE_1_EXTENSION_NAME = "VK_EXT_surface_maintenance1"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SWAPCHAIN_MAINTENANCE_1_EXTENSION_NAME = "VK_EXT_swapchain_maintenance1"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_EXTENSION_NAME = "VK_EXT_shader_demote_to_helper_invocation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME = "VK_NV_device_generated_commands"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_INHERITED_VIEWPORT_SCISSOR_EXTENSION_NAME = "VK_NV_inherited_viewport_scissor"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME = "VK_EXT_texel_buffer_alignment"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_RENDER_PASS_TRANSFORM_EXTENSION_NAME = "VK_QCOM_render_pass_transform"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEPTH_BIAS_CONTROL_EXTENSION_NAME = "VK_EXT_depth_bias_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEVICE_MEMORY_REPORT_EXTENSION_NAME = "VK_EXT_device_memory_report"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_ACQUIRE_DRM_DISPLAY_EXTENSION_NAME = "VK_EXT_acquire_drm_display"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_ROBUSTNESS_2_EXTENSION_NAME = "VK_EXT_robustness2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_CUSTOM_BORDER_COLOR_EXTENSION_NAME = "VK_EXT_custom_border_color"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_GOOGLE_USER_TYPE_EXTENSION_NAME = "VK_GOOGLE_user_type"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_PRESENT_BARRIER_EXTENSION_NAME = "VK_NV_present_barrier"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PRIVATE_DATA_EXTENSION_NAME = "VK_EXT_private_data"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PIPELINE_CREATION_CACHE_CONTROL_EXTENSION_NAME = "VK_EXT_pipeline_creation_cache_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DEVICE_DIAGNOSTICS_CONFIG_EXTENSION_NAME = "VK_NV_device_diagnostics_config"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_RENDER_PASS_STORE_OPS_EXTENSION_NAME = "VK_QCOM_render_pass_store_ops"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_CUDA_KERNEL_LAUNCH_EXTENSION_NAME = "VK_NV_cuda_kernel_launch"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_LOW_LATENCY_EXTENSION_NAME =  "VK_NV_low_latency"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME = "VK_EXT_descriptor_buffer"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME = "VK_EXT_graphics_pipeline_library"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_EXTENSION_NAME = "VK_AMD_shader_early_and_late_fragment_tests"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_FRAGMENT_SHADING_RATE_ENUMS_EXTENSION_NAME = "VK_NV_fragment_shading_rate_enums"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_RAY_TRACING_MOTION_BLUR_EXTENSION_NAME = "VK_NV_ray_tracing_motion_blur"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_YCBCR_2PLANE_444_FORMATS_EXTENSION_NAME = "VK_EXT_ycbcr_2plane_444_formats"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME = "VK_EXT_fragment_density_map2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_ROTATED_COPY_COMMANDS_EXTENSION_NAME = "VK_QCOM_rotated_copy_commands"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME = "VK_EXT_image_robustness"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_COMPRESSION_CONTROL_EXTENSION_NAME = "VK_EXT_image_compression_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_EXTENSION_NAME = "VK_EXT_attachment_feedback_loop_layout"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_4444_FORMATS_EXTENSION_NAME = "VK_EXT_4444_formats"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEVICE_FAULT_EXTENSION_NAME = "VK_EXT_device_fault"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME = "VK_ARM_rasterization_order_attachment_access"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_RGBA10X6_FORMATS_EXTENSION_NAME = "VK_EXT_rgba10x6_formats"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_VALVE_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME = "VK_VALVE_mutable_descriptor_type"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_VERTEX_INPUT_DYNAMIC_STATE_EXTENSION_NAME = "VK_EXT_vertex_input_dynamic_state"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PHYSICAL_DEVICE_DRM_EXTENSION_NAME = "VK_EXT_physical_device_drm"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEVICE_ADDRESS_BINDING_REPORT_EXTENSION_NAME = "VK_EXT_device_address_binding_report"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEPTH_CLIP_CONTROL_EXTENSION_NAME = "VK_EXT_depth_clip_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PRIMITIVE_TOPOLOGY_LIST_RESTART_EXTENSION_NAME = "VK_EXT_primitive_topology_list_restart"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PRESENT_MODE_FIFO_LATEST_READY_EXTENSION_NAME = "VK_EXT_present_mode_fifo_latest_ready"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_HUAWEI_SUBPASS_SHADING_EXTENSION_NAME = "VK_HUAWEI_subpass_shading"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_HUAWEI_INVOCATION_MASK_EXTENSION_NAME = "VK_HUAWEI_invocation_mask"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_EXTERNAL_MEMORY_RDMA_EXTENSION_NAME = "VK_NV_external_memory_rdma"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PIPELINE_PROPERTIES_EXTENSION_NAME = "VK_EXT_pipeline_properties"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_FRAME_BOUNDARY_EXTENSION_NAME = "VK_EXT_frame_boundary"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_EXTENSION_NAME = "VK_EXT_multisampled_render_to_single_sampled"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_EXTENDED_DYNAMIC_STATE_2_EXTENSION_NAME = "VK_EXT_extended_dynamic_state2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_COLOR_WRITE_ENABLE_EXTENSION_NAME = "VK_EXT_color_write_enable"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PRIMITIVES_GENERATED_QUERY_EXTENSION_NAME = "VK_EXT_primitives_generated_query"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_GLOBAL_PRIORITY_QUERY_EXTENSION_NAME = "VK_EXT_global_priority_query"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_VIEW_MIN_LOD_EXTENSION_NAME = "VK_EXT_image_view_min_lod"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MULTI_DRAW_EXTENSION_NAME =  "VK_EXT_multi_draw"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_2D_VIEW_OF_3D_EXTENSION_NAME = "VK_EXT_image_2d_view_of_3d"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_TILE_IMAGE_EXTENSION_NAME = "VK_EXT_shader_tile_image"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_OPACITY_MICROMAP_EXTENSION_NAME = "VK_EXT_opacity_micromap"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_LOAD_STORE_OP_NONE_EXTENSION_NAME = "VK_EXT_load_store_op_none"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_HUAWEI_CLUSTER_CULLING_SHADER_EXTENSION_NAME = "VK_HUAWEI_cluster_culling_shader"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_BORDER_COLOR_SWIZZLE_EXTENSION_NAME = "VK_EXT_border_color_swizzle"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME = "VK_EXT_pageable_device_local_memory"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_ARM_SHADER_CORE_PROPERTIES_EXTENSION_NAME = "VK_ARM_shader_core_properties"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_ARM_SCHEDULING_CONTROLS_EXTENSION_NAME = "VK_ARM_scheduling_controls"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_SLICED_VIEW_OF_3D_EXTENSION_NAME = "VK_EXT_image_sliced_view_of_3d"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_VALVE_DESCRIPTOR_SET_HOST_MAPPING_EXTENSION_NAME = "VK_VALVE_descriptor_set_host_mapping"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEPTH_CLAMP_ZERO_ONE_EXTENSION_NAME = "VK_EXT_depth_clamp_zero_one"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_NON_SEAMLESS_CUBE_MAP_EXTENSION_NAME = "VK_EXT_non_seamless_cube_map"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_ARM_RENDER_PASS_STRIPED_EXTENSION_NAME = "VK_ARM_render_pass_striped"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_FRAGMENT_DENSITY_MAP_OFFSET_EXTENSION_NAME = "VK_QCOM_fragment_density_map_offset"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_COPY_MEMORY_INDIRECT_EXTENSION_NAME = "VK_NV_copy_memory_indirect"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_MEMORY_DECOMPRESSION_EXTENSION_NAME = "VK_NV_memory_decompression"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DEVICE_GENERATED_COMMANDS_COMPUTE_EXTENSION_NAME = "VK_NV_device_generated_commands_compute"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_LINEAR_COLOR_ATTACHMENT_EXTENSION_NAME = "VK_NV_linear_color_attachment"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_GOOGLE_SURFACELESS_QUERY_EXTENSION_NAME = "VK_GOOGLE_surfaceless_query"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_EXTENSION_NAME = "VK_EXT_image_compression_control_swapchain"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_IMAGE_PROCESSING_EXTENSION_NAME = "VK_QCOM_image_processing"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_NESTED_COMMAND_BUFFER_EXTENSION_NAME = "VK_EXT_nested_command_buffer"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXTENSION_NAME = "VK_EXT_external_memory_acquire_unmodified"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_EXTENDED_DYNAMIC_STATE_3_EXTENSION_NAME = "VK_EXT_extended_dynamic_state3"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SUBPASS_MERGE_FEEDBACK_EXTENSION_NAME = "VK_EXT_subpass_merge_feedback"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_LUNARG_DIRECT_DRIVER_LOADING_EXTENSION_NAME = "VK_LUNARG_direct_driver_loading"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_MODULE_IDENTIFIER_EXTENSION_NAME = "VK_EXT_shader_module_identifier"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME = "VK_EXT_rasterization_order_attachment_access"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_OPTICAL_FLOW_EXTENSION_NAME = "VK_NV_optical_flow"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_LEGACY_DITHERING_EXTENSION_NAME = "VK_EXT_legacy_dithering"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PIPELINE_PROTECTED_ACCESS_EXTENSION_NAME = "VK_EXT_pipeline_protected_access"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_AMD_ANTI_LAG_EXTENSION_NAME =    "VK_AMD_anti_lag"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_OBJECT_EXTENSION_NAME = "VK_EXT_shader_object"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_TILE_PROPERTIES_EXTENSION_NAME = "VK_QCOM_tile_properties"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_SEC_AMIGO_PROFILING_EXTENSION_NAME = "VK_SEC_amigo_profiling"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_EXTENSION_NAME = "VK_QCOM_multiview_per_view_viewports"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_RAY_TRACING_INVOCATION_REORDER_EXTENSION_NAME = "VK_NV_ray_tracing_invocation_reorder"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_EXTENDED_SPARSE_ADDRESS_SPACE_EXTENSION_NAME = "VK_NV_extended_sparse_address_space"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME = "VK_EXT_mutable_descriptor_type"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_LEGACY_VERTEX_ATTRIBUTES_EXTENSION_NAME = "VK_EXT_legacy_vertex_attributes"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_LAYER_SETTINGS_EXTENSION_NAME = "VK_EXT_layer_settings"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_ARM_SHADER_CORE_BUILTINS_EXTENSION_NAME = "VK_ARM_shader_core_builtins"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_PIPELINE_LIBRARY_GROUP_HANDLES_EXTENSION_NAME = "VK_EXT_pipeline_library_group_handles"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_EXTENSION_NAME = "VK_EXT_dynamic_rendering_unused_attachments"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_LOW_LATENCY_2_EXTENSION_NAME = "VK_NV_low_latency2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_EXTENSION_NAME = "VK_QCOM_multiview_per_view_render_areas"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_PER_STAGE_DESCRIPTOR_SET_EXTENSION_NAME = "VK_NV_per_stage_descriptor_set"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_IMAGE_PROCESSING_2_EXTENSION_NAME = "VK_QCOM_image_processing2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_FILTER_CUBIC_WEIGHTS_EXTENSION_NAME = "VK_QCOM_filter_cubic_weights"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_YCBCR_DEGAMMA_EXTENSION_NAME = "VK_QCOM_ycbcr_degamma"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_QCOM_FILTER_CUBIC_CLAMP_EXTENSION_NAME = "VK_QCOM_filter_cubic_clamp"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_EXTENSION_NAME = "VK_EXT_attachment_feedback_loop_dynamic_state"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_MSFT_LAYERED_DRIVER_EXTENSION_NAME = "VK_MSFT_layered_driver"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_DESCRIPTOR_POOL_OVERALLOCATION_EXTENSION_NAME = "VK_NV_descriptor_pool_overallocation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_RAW_ACCESS_CHAINS_EXTENSION_NAME = "VK_NV_raw_access_chains"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_COMMAND_BUFFER_INHERITANCE_EXTENSION_NAME = "VK_NV_command_buffer_inheritance"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_SHADER_ATOMIC_FLOAT16_VECTOR_EXTENSION_NAME = "VK_NV_shader_atomic_float16_vector"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_SHADER_REPLICATED_COMPOSITES_EXTENSION_NAME = "VK_EXT_shader_replicated_composites"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_RAY_TRACING_VALIDATION_EXTENSION_NAME = "VK_NV_ray_tracing_validation"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME = "VK_EXT_device_generated_commands"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_MESA_IMAGE_ALIGNMENT_CONTROL_EXTENSION_NAME = "VK_MESA_image_alignment_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_DEPTH_CLAMP_CONTROL_EXTENSION_NAME = "VK_EXT_depth_clamp_control"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_NV_COOPERATIVE_MATRIX_2_EXTENSION_NAME = "VK_NV_cooperative_matrix2"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME = "VK_KHR_acceleration_structure"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME = "VK_KHR_ray_tracing_pipeline"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_KHR_RAY_QUERY_EXTENSION_NAME =   "VK_KHR_ray_query"//achar(0)
  character(len = 1, kind = c_char), parameter :: VK_EXT_MESH_SHADER_EXTENSION_NAME = "VK_EXT_mesh_shader"//achar(0)
